...
public class QueryTextTransform {
    ...
    public static void main(String[] args) {
        ...
        createDatstore();
        QueryTextTransform i = new QueryTextTransform();
        ...
        for (File file : listOfFiles) {
            if (file.isFile()) {
                ...
                try {
                    ...
                    /////////////////////////////////////////////////////////////////////
                    String fname = file.getName().replace("html","txt");
                    ...
                    while ((line = br.readLine()) != null) {
                       ...
                       if(line.contains("<DOC>") || line.contains("</DOC>") || line.contains("<DOCNO>") || line.contains("</DOCNO>") ) {
                           bw.write(line + "\n");
                       }
                       else
                       {
